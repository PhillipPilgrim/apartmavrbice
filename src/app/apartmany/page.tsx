				...
				<section className="flex flex-col items-center gap-4 pt-20 pb-12 text-center md:pt-44 md:pb-24">
					...
					<div className="relative mx-auto w-full max-w-3xl">
						...
						>
							<div
								className="space-y-3"
								dangerouslySetInnerHTML={{ __html: t("apartments.description") }}
							/>
						</motion.div>
						...
						>
							<div className="group relative flex flex-col items-center">
								...
								/>
								<span className="text-md absolute right-full mr-2 hidden w-24 rounded bg-gray-300 px-2 py-1 text-black group-hover:block">
									{t("about.wifi")}
								</span>
							</div>
							<div className="group relative flex flex-col items-center">
						...
						>
							<div className="group relative flex flex-col items-center">
								<IoTv
									...
									className="border-3 border-[#e94629] p-1 text-[#e94629] transition-transform duration-300 group-hover:scale-105"
								/>
								<span className="text-md absolute left-full ml-2 hidden w-28 rounded bg-gray-300 px-2 py-1 text-black group-hover:block">
									{t("about.tv")}
								</span>
							</div>
							<div className="group relative flex flex-col items-center">
							...
							<div className="group relative flex flex-col items-center">
								<IoLogoNoSmoking
									...
									className="border-3 border-[#e94629] p-1 text-[#e94629] transition-transform duration-300 group-hover:scale-105"
								/>
								<span className="text-md absolute left-full ml-2 hidden w-32 rounded bg-gray-300 px-2 py-1 text-black group-hover:block">
									{t("about.smoking")}
								</span>
							</div>
						</motion.div>
