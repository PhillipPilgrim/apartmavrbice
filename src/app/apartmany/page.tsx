			...
			<div className="relative z-10 mx-auto max-w-7xl px-4">
				<section className="flex flex-col items-center gap-4 pt-20 pb-12 text-center md:pt-44 md:pb-24">
					...
					<div className="relative mx-auto w-full max-w-3xl">
						...
						>
							<div dangerouslySetInnerHTML={{ __html: t("apartments.description") }} />
						</motion.div>
						...
						{/* Stejné tooltipy pro větší obrazovky */}
						<motion.div
						...
						>
							<div className="group relative flex flex-col items-center">
								<IoTv
									...
									className="border-3 border-[#e94629] p-1 text-[#e94629] transition-transform duration-300 group-hover:scale-105"
								/>
								<span className="text-md absolute left-full ml-2 hidden rounded bg-gray-300 px-2 py-1 w-24 text-black group-hover:block">
									{t("about.tv")}
								</span>
							</div>
							<div className="group relative flex flex-col items-center">
				...
				<section className="flex w-full flex-col items-center justify-center gap-12 pb-12 lg:flex-row lg:items-start">
